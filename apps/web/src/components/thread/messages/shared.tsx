...
export function BranchSwitcher({
  ...
  readonly branchOptions: string[] | undefined;
  ...
  return (
    <div className="flex items-center gap-2">
      <Button
        variant="ghost"
        size="icon"
        className="size-6 p-1 text-white hover:bg-white/10 hover:text-white disabled:opacity-30"
        onClick={() => {
